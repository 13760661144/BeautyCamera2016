...
public class LiveVideoStickerResRedDotMgr2 extends BaseResMgr<LiveVideoStickerRedDotRes, SparseArray<LiveVideoStickerRedDotRes>>
{
...
//    public static final String CLOUD_URL = "http://tw.adnonstop.com/beauty/app/api/app_source/biz/beta/api/public/index.php?r=Switch/RedDotList";
    ...
    public static final String SDCARD_PATH = DownloadMgr.getInstance().RESOURCE_RED_DOT_PATH + "/live_sticker_red_dot.xxxx";
    public static final String CLOUD_CACHE_STICKER_PATH = DownloadMgr.getInstance().RESOURCE_RED_DOT_PATH + "/live_sticker_red_dot_cache.xxxx";
    ...
    private static LiveVideoStickerResRedDotMgr2 sInstance;

    private LiveVideoStickerResRedDotMgr2()
    {
    }


    public synchronized static LiveVideoStickerResRedDotMgr2 getInstance()
    {
        if (sInstance == null)
        {
            sInstance = new LiveVideoStickerResRedDotMgr2();
        }
        return sInstance;
    }
    ...
    protected Object sync_raw_ReadCloudData(Context context, DataFilter filter)
    {
        ...
        try
        {
            ...
            data = MaterialResourceProtocol.Get(CLOUD_URL,
                    ...
                    MaterialResourceProtocol.GetReqParams(PageType.LIVE_STICKER, MaterialResourceProtocol.IS_DEBUG, new ResourceGroup[]{ResourceGroup.DOWNLOAD}),
    ...
    @Override
    public boolean CheckIntact(LiveVideoStickerRedDotRes res)
    {
    ...
    @Override
    public LiveVideoStickerRedDotRes ReadResItem(JSONObject jsonObject, boolean isPath)
    {
    ...
    {
        return EventID.LIVE_RED_DOT_STICKER_CLOUD_OK;
    }
}
