...
//    public static final String CLOUD_URL = "http://tw.adnonstop.com/beauty/app/api/app_source/biz/beta/api/public/index.php?r=Switch/RedDotList";
    ...
    private static VideoStickerGroupResRedDotMrg2 sInstance;
    ...
    public synchronized static VideoStickerGroupResRedDotMrg2 getInstance()
    {
        if (sInstance == null)
        {
            sInstance = new VideoStickerGroupResRedDotMrg2();
        }
        return sInstance;
    }
    ...
    protected Object sync_raw_ReadCloudData(Context context, DataFilter filter)
    {
        ...
        try
        {
            ...
            data = MaterialResourceProtocol.Get(CLOUD_URL,
                    ...
                    MaterialResourceProtocol.GetReqParams(PageType.STICKER_TAG, MaterialResourceProtocol.IS_DEBUG, new ResourceGroup[]{ResourceGroup.DOWNLOAD}),
    ...
    {
        return EventID.RED_DOT_STICKER_TAG_CLOUD_OK;
    }
    ...
    @Override
    protected VideoStickerRedDotRes ReadResItem(JSONObject jsonObject, boolean isPath)
    {
