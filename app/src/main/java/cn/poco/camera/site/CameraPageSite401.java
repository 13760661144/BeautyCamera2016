 ...
 * 独立登录Activity调用
 * {@link CameraPageSite63}
 */

public class CameraPageSite401 extends CameraPageSite63
{
	@Override
	public void onTakePicture(Context context, HashMap<String, Object> params)
	{
		...
		MyFramework.SITE_Popup(context, EditHeadIconImgPageSite401.class, datas, Framework2.ANIM_TRANSITION);
	}
