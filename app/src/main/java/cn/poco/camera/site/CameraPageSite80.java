...
/**
 * 保存脸型数据上传，登陆，注册，选择头像，到拍照
 */
public class CameraPageSite80 extends CameraPageSite
{
    @Override
    public void onTakePicture(Context context, HashMap<String, Object> params)
    {
        ...
        MyFramework.SITE_Popup(context, EditHeadIconImgPageSite11.class, datas, Framework2.ANIM_TRANSITION);
    }
