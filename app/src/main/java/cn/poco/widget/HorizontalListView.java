...
public class HorizontalListView extends AdapterView<ListAdapter> {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= 11) {//3.0	//Build.VERSION_CODES.HONEYCOMB
...
//        }
    ...
    private void initView() {
        ...
        setCurrentScrollState(OnScrollListener.SCROLL_STATE_IDLE);
    }
    ...
    private float determineFlingAbsorbVelocity() {
        // If the OS version is high enough get the real velocity *///4.0
    ...
    public void scrollTo(int x) {
        ...
        setCurrentScrollState(OnScrollListener.SCROLL_STATE_FLING);
        requestLayout();
    }
    ...
    private class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            setCurrentScrollState(OnScrollListener.SCROLL_STATE_TOUCH_SCROLL);
            unpressTouchedChild();
     ...
     *
     * @param onScrollListener The listener to be invoked.
     */
    ...
    public void invokeOnItemScrollListener() {
        if (mOnScrollListener != null) {
            mOnScrollListener.onScroll(this, mLeftViewAdapterIndex, getChildCount(), mItemCount);
        }
    ...
    private void setCurrentScrollState(int newScrollState) {
        ...
        if (mCurrentScrollState != newScrollState && mOnScrollListener != null) {
            mOnScrollListener.onScrollStateChanged(this, newScrollState);
        }
    ...
    private void updateOverscrollAnimation(final int scrolledOffset) {
        ...
        // if dx=0 won't notify scroll listener
        if (mCurrentX - oldX != 0)
...
//                scroller.setFriction(friction);
    ...
    private static final class IceCreamSandwichPlus {
        static {
            if (Build.VERSION.SDK_INT < 14) {//4.0	//Build.VERSION_CODES.ICE_CREAM_SANDWICH
