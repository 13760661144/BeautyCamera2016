...
public class AlbumSite17 extends AlbumSite
{
	...
	public void onPhotoSelected(Context context, Map<String, Object> params)
	{
		...
		MyFramework.SITE_Popup(context, EditHeadIconImgPageSite.class, temp, Framework2.ANIM_NONE);
	}
	...
	public void onOpenCamera(Context context) {
		...
		MyFramework.SITE_Open(context, CameraPageSite63.class, params, Framework2.ANIM_NONE);
	}
}
