...
import cn.poco.camera.site.CameraPageSite401;
...
public class AlbumSite401 extends AlbumSite
{
	@Override
	public void onPhotoSelected(Context context, Map<String, Object> params)
	{
		...
		MyFramework.SITE_Popup(context, EditHeadIconImgPageSite401.class, temp, Framework2.ANIM_NONE);
	}
	...
	public void onOpenCamera(Context context)
	{
		...
		MyFramework.SITE_Open(context, CameraPageSite401.class, params, Framework2.ANIM_NONE);
	}
}
