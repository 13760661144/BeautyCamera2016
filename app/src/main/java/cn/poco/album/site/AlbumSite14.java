...
import cn.poco.camera.site.CameraPageSite7;
 ...
 * 弹窗协议到美颜，保存时自动跳到分享页面
 */
public class AlbumSite14 extends AlbumSite {
	...
	public void onOpenCamera(Context context) {
		...
		MyFramework.SITE_Open(context, CameraPageSite7.class, params, Framework2.ANIM_NONE);
	}
}
