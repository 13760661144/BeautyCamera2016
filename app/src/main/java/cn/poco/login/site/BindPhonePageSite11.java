...
/**
 * 保存脸型数据 第三方登陆强制绑定手机填写验证码，填写验证码
 */
public class BindPhonePageSite11 extends BindPhonePageSite
{
    ...
    public void bindSuccess(HashMap<String, Object> datas, Context context)
    {
        ...
        MyFramework.SITE_Open(context, ResetPswPageSite11.class, datas, Framework2.ANIM_NONE);
    }
