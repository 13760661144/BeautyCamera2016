...
//分享界面到登录
public class LoginPageSite10 extends LoginPageSite
{
	@Override
	...
	public void creatAccount(HashMap<String, Object> datas,Context context)
	{
		...
		MyFramework.SITE_Open(context, RegisterLoginPageSite2.class, params, Framework2.ANIM_NONE);
	}
	...
	public void LosePsw(HashMap<String, Object> datas,Context context)
	{
		...
		MyFramework.SITE_Open(context,ResetLoginPswPageSite2.class,params,Framework2.ANIM_NONE);
	}
	...
	public void thirdPartLoginOneStepFinish(Context context, LoginInfo info,LoginStyle.LoginBaseInfo baseInfo) {
		...
		MyFramework.SITE_Open(context, BindPhonePageSite6.class,params,Framework2.ANIM_NONE);
	}
}
