...
public class IRecyclerView extends RecyclerView {
    ...
    private void move(int dy) {
        if (dy != 0) {
            ...
            height = height > ShareData.PxToDpi_xhdpi(150) ? ShareData.PxToDpi_xhdpi(150) : height;
...
//                    }
    ...
    public abstract class OnLoadMoreScrollListener extends RecyclerView.OnScrollListener {
        ...
        public boolean canTriggerLoadMore(RecyclerView recyclerView) {
            ...
            boolean positionCondition = totalItemCount - 1 == position;
            boolean isAnimationEnd = mStatus == STATUS_DEFAULT;
            return positionCondition && isAnimationEnd;
        }
