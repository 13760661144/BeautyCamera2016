...
public final class EglCore extends EglCoreAbs<EGLContext, EGLConfig, EGLSurface> {
    ...
    private EGLConfig getConfig(int flags, int version) {
        ...
        if (!EGL14.eglChooseConfig(mEGLDisplay, attribList, 0, configs, 0, 1, numConfigs, 0)) {
            ...
            int[] mMinimumSpec = {
                    ...
                    //EGL14.EGL_TRANSPARENT_TYPE, EGL14.EGL_NONE,
                    EGL14.EGL_NONE
            };

            EGL14.eglChooseConfig(mEGLDisplay, mMinimumSpec, 0, configs, 0, 3, numConfigs, 0);
    ...
    public int[] chooseConfig(EGLConfig[] configs, int flags, int renderableType) {
        ...
        for(EGLConfig config : configs) {
            ...
            EGL14.eglGetConfigAttrib(mEGLDisplay, config, EGL14.EGL_RED_SIZE, attributes, 0);
            EGL14.eglGetConfigAttrib(mEGLDisplay, config, EGL14.EGL_GREEN_SIZE, attributes, 1);
            EGL14.eglGetConfigAttrib(mEGLDisplay, config, EGL14.EGL_BLUE_SIZE, attributes, 2);
            EGL14.eglGetConfigAttrib(mEGLDisplay, config, EGL14.EGL_ALPHA_SIZE, attributes, 3);
