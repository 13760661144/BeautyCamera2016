 ...
 * 动态贴纸
 * @deprecated
 * use {@link BeautyVideoPageSite} and {@link BeautyPhotoPageSite}
 */
@Deprecated
public class LightApp06PageSite extends BaseSite {
     ...
     * @param isVideo
     */
    public void OnThirdPartySave(Context context, String path, boolean isVideo)
    {
        if (isVideo)
        {
     ...
     * @param isVideo
     */
    public void OnThirdPartyBack(Context context, boolean isVideo)
    {
        if (isVideo)
        {
            HashMap<String, Object> params = new HashMap<>();
    ...
    public void OnCamera(Context context)
    {
        ...
        MyFramework.SITE_Open(context, true, CameraPageSite2.class, params, Framework2.ANIM_NONE);
    }
