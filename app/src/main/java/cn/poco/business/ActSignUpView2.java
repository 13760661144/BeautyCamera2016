...
public class ActSignUpView2 extends RelativeLayout
{
	...
	public ActSignUpView2(Context context, AttributeSet attrs, int defStyle)
	{
		super(context, attrs, defStyle);
		initialize(context);
	}

	public ActSignUpView2(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		initialize(context);
	}
	...
	protected ActSignUpDialog2 mDialog;
...
//				ll = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int)(ShareData.m_screenHeight * 0.45f));
	...
	public void onSkip()
	{
		if(mDialog != null)
		{
			mDialog.onOk(null);
			//兰蔻商业统计
			Utils.UrlTrigger(getContext(),"http://cav.adnonstop.com/cav/fe0a01a3d9/0073003197/?url=https://a-m-s-ios.poco.cn/images/blank.gif");
		}
	}
	...
	public void onOk()
	{
		...
		{
			//兰蔻商业统计
			Utils.UrlTrigger(getContext(),"http://cav.adnonstop.com/cav/fe0a01a3d9/0073003195/?url=https://a-m-s-ios.poco.cn/images/blank.gif");
