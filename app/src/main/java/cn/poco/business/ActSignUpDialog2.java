...
public class ActSignUpDialog2 extends Dialog
{
	...
	public ActSignUpDialog2(Context context, boolean cancelable, OnCancelListener cancelListener)
	{
		super(context, cancelable, cancelListener);
	}

	public ActSignUpDialog2(Context context, int theme)
	{
		super(context, theme);
	}
	...
	private ActSignUpView2 mSignUpView;
	private Bitmap mBk;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		mSignUpView = new ActSignUpView2(getContext());
