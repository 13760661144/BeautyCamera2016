...
class IcsLinearLayout extends LinearLayout
{
    ...
    public void setDividerColor(int mDividerColor)
    {
        ...
        mDivideLinePaint.setColor(mDividerColor);
        invalidate();
    }
    ...
    public void setShowDividers(int mShowDividers)
    {
    ...
    {
        canvas.drawRect(getPaddingLeft() + mDividerPadding, top,
                getWidth() - getPaddingRight() - mDividerPadding, top + mDividerHeight, mDivideLinePaint);
    }
